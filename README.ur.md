...
- **سافٹ ویئر کا انتخاب**: انسٹال کرنے کے لیے اضافی سافٹ ویئر منتخب کریں:
  ...
  - Ollama (اوپن سورس ماڈلز استعمال کرنے کے لیے مقامی Ollama انسٹینس سے منسلک ہوں)
...
- **سائیڈ بار نیویگیشن**: تمام کنفیگریشن سیکشنز کے لیے فوری رسائی کے ساتھ ایک قابل تغیر سائیڈ بار
- **منقسم پین لیآؤٹ**: ایڈیٹر اور لائیو پریویو کے ساتھ ایک دوسرے کے ساتھ سائز کے قابل لوحات
- **RTL زبان کی سپورٹ**: اردو، عربی اور عبرانی کے لیے مکمل دائیں سے بائیں معاونت

### عمومی خصوصیات

- **لائیو پریویو**: بنائی گئی کنفیگریشن فائلوں کا ریئل ٹائم پریویو منقسم پین میں دیکھیں
...
- **ترتیب کی تاریخ**: واپس لیں/دوبارہ کریں کی فعالیت کے ساتھ تبدیلیوں کو ٹریک کریں
  - تاخیر شدہ سنیپ شاٹس کے ساتھ خودکار تبدیلی ٹریکنگ
  - کی بورڈ شارٹ کٹس کے ساتھ واپس لیں/دوبارہ کریں (`Ctrl+Z` / `Ctrl+Y`)
  - ٹائم سٹیمپس اور تبدیلی کی تفصیلات کے ساتھ تاریخ پینل
  - کسی بھی حالت کا موازنہ کرنے کے لیے فرق کا نظارہ
  - کسی بھی سابقہ ترتیب کی حالت میں بحال کریں
  - استقامت کے لیے IndexedDB میں ذخیرہ (زیادہ سے زیادہ 50 اندراجات)
...
| `Ctrl/⌘ + E` | پریویو پین ٹوگل کریں |
| `Ctrl/⌘ + B` | سائیڈ بار ٹوگل کریں |
| `Ctrl/⌘ + Z` | واپس لیں |
| `Ctrl/⌘ + Y` | دوبارہ کریں |
| `Ctrl/⌘ + Shift + Z` | دوبارہ کریں (متبادل) |
| `Ctrl/⌘ + Shift + D` | ڈارک/لائٹ موڈ ٹوگل کریں |
| `Ctrl/⌘ + Shift + X` | ڈیفالٹ پر ری سیٹ کریں |
| `Ctrl/⌘ + Shift + L` | زبان تبدیل کرنے والا کھولیں |
| `Ctrl/⌘ + 1-5` | سیکشن میں جائیں (1=Dockerfile، 2=Docker Compose، 3=CLAUDE.md، 4=settings.json, 5=DevContainer) |
...
- سافٹ ویئر پیکیج کے طور پر Ollama سپورٹ شامل کی گئی
  ...
  - فعال ہونے پر خود بخود `ANTHROPIC_BASE_URL` اور `ANTHROPIC_AUTH_TOKEN` سیٹ کرتا ہے
  - Ollama غیر فعال ہونے پر ماحولیاتی متغیرات ہٹا دیے جاتے ہیں
- میزبان نیٹ ورک تک رسائی کے لیے docker-compose.yaml میں `extra_hosts` کنفیگریشن شامل کی گئی

### v4.0.2

- **بڑی UI/UX دوبارہ ڈیزائن**: استعمال کو بہتر بنانے کے لیے مکمل انٹرفیس ری ڈیزائن
  - عمودی کارڈ پر مبنی لے آؤٹ کو سائیڈ بار + منقسم پین کے ساتھ تبدیل کیا
  - سائیڈ بار نیویگیشن کی بورڈ شارٹ کٹس کے ساتھ فوری سیکشن سوئچنگ کے لیے (`Ctrl/⌘ + 1-5`)
  - ایڈیٹر اور لائیو پریویو کے ساتھ سائز کے قابل منقسم پین
  - آئکن صرف موڈ کے ساتھ قابل تغیر سائیڈ بار (`Ctrl/⌘ + B` کے لیے ٹوگل کریں)
  - شناختی بوجھ کو کم کرنے کے لیے accordion سیکشنز کے ساتھ ترقی پذیر فاش
- **RTL زبان کی سپورٹ**: اردو، عربی اور عبرانی کے لیے مکمل دائیں سے بائیں معاونت
  - RTL زبانوں کے لیے سائیڈ بار خود بخود دائیں جانب آتا ہے
  - تمام UI عناصر صحیح طریقے سے عکاس ہیں
- **نیریس ایکٹری بہتریاں**:
  - ٹیبلٹ سکرین پر سائیڈ بار شروع میں بند ہوتا ہے (768–1023px)
  - موبائل کے لیے بہتر لے آؤٹ نیچے کی شیٹ پریویو کے ساتھ
  - قابل قبول accordion ٹریجرز (کم از کم 44px اونچائی)
- **خوش آمدید ڈائیلاگ**: پہلی بار آنے والے صارفین کو سٹاٹک کارڈ کی بجائے خوش آمدید ڈائیلاگ نظر آتا ہے
  - سائیڈ بار میں "تعارف" کے ذریعے دوبارہ کھول سکتے ہیں
- **وراثت میں آنے والے اجزاء کو ہٹایا**: پرانے کارڈ پر مبنی اجزاء صاف کیے
- نئی لے آؤٹ کے ساتھ کام کرنے کے لیے کی بورڈ شارٹ کٹس اپ ڈیٹ کیے

### v3.2.1

- واپس لیں/دوبارہ کریں کی فعالیت کے ساتھ ترتیب کی تاریخ شامل کی گئی
  - تاخیر شدہ سنیپ شاٹس کے ساتھ خودکار تبدیلی ٹریکنگ (500ms)
  - کی بورڈ شارٹ کٹس کے ساتھ واپس لیں/دوبارہ کریں (`Ctrl/⌘ + Z` / `Ctrl/⌘ + Y`)
  - ٹائم سٹیمپس اور تبدیلی کی تفصیلات کے ساتھ تاریخ پینل
  - ترتیبات کا موازنہ کرنے کے لیے فرق کا نظارہ
  - کسی بھی سابقہ حالت میں بحال کریں
  - استقامت کے لیے IndexedDB سٹوریج (زیادہ سے زیادہ 50 اندراجات)
- VS Code اور GitHub Codespaces کے لیے DevContainer سپورٹ شامل کیا گیا
  - `devcontainer.json` ترتیب بنائیں
  - VS Code ایکسٹینشنز اور سیٹنگز کنفیگر کریں
  - Dev Container خصوصیات شامل کریں
  - پورٹ فارورڈنگ سیٹ اپ کریں
  - لائف سائیکل کمانڈز کنفیگر کریں (post-create، post-start، post-attach)
  - منتخب سافٹ ویئر کی بنیاد پر خودکار ایکسٹینشن سفارشات
- DevContainer کارڈ پر سکرول کرنے کے لیے کی بورڈ شارٹ کٹ `Ctrl/⌘ + 5` شامل کیا گیا
- DevContainer فیچر کے ساتھ خوش آمدید سیکشن اپ ڈیٹ کیا گیا
