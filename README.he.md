...
- **ניווט בצד סרגל**: גישה מהירה לכל קטעי התצורה עם סרגל צד שניתן לכיווץ
- **פריסת חלוקה**: עורך וצפייה חיה זה ליד זה עם לוחות בגודל משתנה
- **תמיכת שפות RTL**: תמיכה מלאה מימין לשמאל לערבית, עברית וְאוּרדוּ

### תכונות כלליות

- **תצוגה מקדימה חיה**: צפייה בזמן אמת בקבצי תצורה שנוצרו בחלונית התצוגה המקדימה
...
- **היסטוריית תצורה**: מעקב אחר שינויים עם פונקציונליות ביטול/שחזור
  - מעקב אוטומטי אחר שינויים עם תמונות מצב מושהות
  - ביטול/שחזור עם קיצורי מקלדת (`Ctrl+Z` / `Ctrl+Y`)
  - פאנל היסטוריה עם חותמות זמן ותיאורי שינויים
  - תצוגת הבדלים להשוואת מצבים
  - שחזור לכל מצב תצורה קודם
  - מאוחסן ב-IndexedDB לשמירה (מקסימום 50 רשומות)
...
| ----- | ----- |
| `Ctrl/⌘ + S` | הורדת ZIP |
| `Ctrl/⌘ + E` | החלפת חלונית התצוגה המקדימה |
| `Ctrl/⌘ + B` | החלפת סרגל הצד |
| `Ctrl/⌘ + Z` | בטל |
| `Ctrl/⌘ + Y` | שחזר |
| `Ctrl/⌘ + Shift + Z` | שחזר (חלופי) |
| `Ctrl/⌘ + Shift + D` | החלפת מצב כהה/בהיר |
| `Ctrl/⌘ + Shift + X` | איפוס לברירות מחדל |
| `Ctrl/⌘ + Shift + L` | פתיחת בורר שפה |
| `Ctrl/⌘ + 1-5` | עברו לקטע (1=Dockerfile, 2=Docker Compose, 3=CLAUDE.md, 4=settings.json, 5=DevContainer) |
...
- **עיצוב משתנה גדול של ממשק/חוויית משתמש**: שיפוץ ממשק מלא לשיפור השימושיות
  - החלפת פריסה רכוכה מבוססת כרטיס עם פריסת סרגל צד + חלוקה
  - ניווט סרגל צד לעברור מהיר בקטעים עם קיצורי מקלדת (`Ctrl/⌘ + 1-5`)
  - חלונית חלוקה בגודל משתנה עם עורך וצפייה חיה זה ליד זה
  - סרגל צד שניתן לכיווץ עם מצב רמזים בלבד (`Ctrl/⌘ + B` להחלפה)
  - גילוי הדרגתי עם קטעי אקורדיון לצמצום עומס קוגניטיבי
- **תמיכת שפות RTL**: תמיכה מלאה מימין לשמאל לערבית, עברית וְאוּרדוּ
  - סרגל הצד ממוקם באופן אוטומטי מימין לשפות RTL
  - כל אלמנטי הממשק מהופכים כראוי
- **שיפורים בתגובתיות**:
  - סרגל הצד מתחיל מקובץ בשני טאבלט (768–1023 פיקסלים)
  - פריסה המותאמת לטלפון נייד עם תצוגה מוקדמת של גליון תחתון
  - הפעלי אקורדיון ידידותיים למגע (גובה מינימום 44 פיקסל)
- **דיאלוג ברכה**: מבקרים חדשים רואים דיאלוג ברכה במקום כרטיס סטטי
  - ניתן לפתוח מחדש דרך "אודות" בסרגל הצד
- **הסרת רכיבים מורשים**: ניקוי רכיבים ישנים מבוססי כרטיסים
- קיצורי מקלדת מעודכנים לעבודה עם הפריסה החדשה

### v3.2.1

- הוספת היסטוריית תצורה עם פונקציונליות ביטול/שחזור
  - מעקב אוטומטי אחר שינויים עם תמונות מצב מושהות (500ms)
  - ביטול/שחזור עם קיצורי מקלדת (`Ctrl/⌘ + Z` / `Ctrl/⌘ + Y`)
  - פאנל היסטוריה עם חותמות זמן ותיאורי שינויים
  - תצוגת הבדלים להשוואת תצורות
  - שחזור לכל מצב קודם
  - אחסון ב-IndexedDB לשמירה (מקסימום 50 רשומות)
- הוספת תמיכה ב-DevContainer עבור VS Code ו-GitHub Codespaces
  - יצירת תצורת `devcontainer.json`
  - הגדרת הרחבות והגדרות VS Code
  - הוספת תכונות Dev Container
  - הגדרת העברת פורטים
  - הגדרת פקודות מחזור חיים (post-create, post-start, post-attach)
  - המלצות אוטומטיות להרחבות בהתבסס על התוכנה הנבחרת
- הוספת קיצור מקלדת `Ctrl/⌘ + 5` לגלילה לכרטיס DevContainer
- עדכון מדור קבלת פנים עם תכונת DevContainer
