...
- **תוספי Claude Code**: התקנת תוספי Claude Code מחנויות בפורמט `plugin-name@marketplace-name`
  - **הצעות תוספים**: טוען אוטומטית הצעות תוספים מ[חנות Anthropic הרשמית](https://github.com/anthropics/claude-plugins-official) ברקע
  - לחיצה אחת להוספת תוספים מוצעים
  - קישורים חיצוניים לצפייה בתוספים ב-GitHub
